/*\
title: $:/plugins/nikorion/math/modules/calc.widget.js
type: application/javascript
module-type: widget
\*/

/*
 * calc.widget.js — <$calc> widget 🧮
 *
...
(function () {
  ...
  // Read an attribute from the widget; if not set, fall back to the
  // per-attribute state tiddler, then to hardDefault.
